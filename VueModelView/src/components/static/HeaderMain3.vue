    ...
    >
      <div class="container">
        <router-link class="navbar-brand text-primary fw-bold" to="/">
          <img src="@/assets/resource/img/logo.png" style="width: 5vw" />
        </router-link>
        <button
          ...
          <!-- <ul class="navbar-nav mb-2 me-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <a class="dropdown-item" href="${root}/user/mypage">
                    마이페이지
                  </a>
                </li>
              </ul>
          ...
          <div class="modal-body">
            <form id="form-join" method="post">
              <div class="row">
                ...
                <!-- 아이디 -->
                <div class="col-md-3" style="padding: 5px; text-align: center">
                  <label for="name" class="form-label text-center"
                    >아이디</label
                  >
                </div>
                <div class="col-md-9">
                  ...
                  >
                    <li>
                      <a
                        class="dropdown-item"
                        href="#"
                        @click="setEmailDomain('naver.com')"
                        >naver.com</a
                      >
                    </li>
                    <li>
                      <a
                        class="dropdown-item"
                        href="#"
                        @click="setEmailDomain('gmail.com')"
                        >gmail.com</a
                      >
                    </li>
                    <li>
                      <a
                        class="dropdown-item"
                        href="#"
                        @click="setEmailDomain('kakao.com')"
                        >kakao.com</a
                      >
                    </li>
                  </ul>
