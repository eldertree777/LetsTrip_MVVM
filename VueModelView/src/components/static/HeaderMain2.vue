      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="attraction.html"
                ><i class="fa-solid fa-map-location-dot"></i> 지역별여행지</a
              >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="hotplace.html"
                ><i class="fa-solid fa-camera"></i> 핫플자랑하기</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="board.jsp"
                ><i class="fa-solid fa-list"></i> 여행정보공유</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="notice.html"
          ...
          <!-- 로그인 후 -->
          <div id="after_login" class="d-flex" style="display: none !important">
            <div>
              <a href="#" target="_self" class="nav-link"
                ><span class="badge rounded-pill bg-primary">S</span> ssafy님
                환영합니다.
              </a>
            </div>
            <div>
              <a
                ...
                href="#"
                data-bs-toggle="modal"
                data-bs-target="#mypage_modal"
                ><i class="fa-solid fa-user"></i> 마이페이지</a
              >
            </div>
            <div>
              <a class="logout dropdown-item ms-2" href="#" onclick="logout()"
                ><i
